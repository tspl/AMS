<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="General Room Allocation.aspx.cs" Inherits="General_Room_Allocation" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Label ID="lblhead" runat="server" 
                ...
                Font-Size="Medium" Text="GENERAL ROOM ALLOCATION"></asp:Label>
<asp:UpdatePanel id="UpdatePanel1" runat="server">
        <contenttemplate>
<table><tbody><tr align=center><td colSpan=5>
    <asp:Panel ID="pnlcash" runat="server" 
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtcashierliability" runat="server" Font-Bold="True" 
                            Font-Size="Small" tabIndex="53" Width="66px" Enabled="False"></asp:TextBox>
                    </td>
                    <td align="left">
                        <asp:LinkButton ID="lnkreceipt" runat="server" CausesValidation="False" 
                            onclick="lnkreceipt_Click">Receipt no:</asp:LinkButton>
                    </td>
                    <td style="WIDTH: 100px">
                        <asp:TextBox ID="txtreceiptno1" runat="server" 
                            OnTextChanged="txtreceiptno1_TextChanged" tabIndex="51" Width="66px" 
                            Enabled="False"></asp:TextBox>
                 <TD style="WIDTH: 100px"><asp:Label id="Label1" runat="server" Width="122px" Text="No of Transactions"></asp:Label></TD><TD style="WIDTH: 100px">
                        <asp:TextBox id="txtnooftrans" tabIndex=55 runat="server" Width="66px" 
                ...
                <td style="WIDTH: 100px">
                    ...
                    <td style="WIDTH: 100px">
                        <asp:TextBox ID="txtunclaimed" runat="server" Font-Bold="True" 
                            Font-Size="Small" tabIndex="54" Width="66px" Enabled="False"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td style="WIDTH: 50px">
        ...
        <td>
            <asp:TextBox ID="txtcounterliability" runat="server" 
                Width="66px" Enabled="False"></asp:TextBox>
        </td>
              <td style="WIDTH: 100px">
                    ...
                    <td style="WIDTH: 100px">
                        <asp:TextBox ID="txtreceiptno2" runat="server" 
                            OnTextChanged="txtreceiptno2_TextChanged" tabIndex="52" Width="66px" 
                            Enabled="False"></asp:TextBox>
                    </td>
                    <td style="WIDTH: 100px">
    ...
    <tr align="center">
        ...
        <td colspan="1" align="left" style="width: 30%">
                        ...
                        <tr>
                            ...
                            <td style="WIDTH: 284px; HEIGHT: 2px">
                                <asp:TextBox ID="txtswaminame" runat="server" AutoPostBack="True" 
                                    ...
                                    OnTextChanged="txtswaminame_TextChanged1" tabIndex="30" Width="200px"></asp:TextBox>
                            </td>
                            <td>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="WIDTH: 284px; HEIGHT: 23px">
                                <asp:TextBox ID="txtplace" runat="server" AutoPostBack="True" 
                                    CssClass="UpperCaseFirstLetter" Height="17px" 
                                    OnTextChanged="txtplace_TextChanged" tabIndex="31" Width="200px"></asp:TextBox>
                            </td>
                            <td>
                                <BR />
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtnoofinmates" runat="server" AutoPostBack="True" 
                                    Height="17px" OnTextChanged="TextBox5_TextChanged" tabIndex="34" 
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="cmbRooms" runat="server" 
                                    ...
                                    tabIndex="33" Width="175px" style="height: 22px">
                                    <asp:ListItem Value="-1">--Select--</asp:ListItem>
                                </asp:DropDownList>
                            </td>
                            <td>
                         ...
                         <tr>
                             ...
                             <td style="height: 34px">
                                 <asp:TextBox ID="txthours" runat="server" ReadOnly="True" 
                                     Width="170px" ontextchanged="txthours_TextChanged" AutoPostBack="True" 
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td style="WIDTH: 100px; HEIGHT: 17px">
                                <asp:Label ID="Label103" runat="server" Text="Inmate Charge"></asp:Label>
                            </td>
    ...
    <tr>
        ...
        <td>
            <asp:DropDownList ID="ddlpayment" runat="server" AutoPostBack="True" 
                ...
                onselectedindexchanged="ddlpayment_SelectedIndexChanged" Width="200px" 
                TabIndex="37">
            </asp:DropDownList>
        </td>
        <td colspan="2">
                    ...
                    <tr>
                        <td>
                            <asp:Button ID="btnallocate" runat="server" CssClass="btnStyle_medium" 
                                Font-Bold="True" onclick="btnallocate_Click" tabIndex="36" 
                                Text="Allocate" />
                        </td>
                        <td>
                        ...
                        <td>
                            <asp:Button ID="btncancel" runat="server" CausesValidation="False" 
                                CssClass="btnStyle_medium" Font-Bold="True" onclick="btncancel_Click" 
                                tabIndex="23" />
                        </td>
                        <td>
        ...
        <td align="center" colspan="5">
            <asp:GridView ID="gdroomallocation" runat="server" AllowPaging="True" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Inmates" HeaderText="Inmates" />
            ...
            <asp:GridView ID="gdletter" runat="server" __designer:wfdid="w14" 
                ...
                Caption="Reserved Rooms" CellPadding="4" DataKeyNames="id" ForeColor="#333333" 
                GridLines="None" onpageindexchanging="gdletter_PageIndexChanging" 
                onrowcreated="gdletter_RowCreated" 
                onselectedindexchanged="gdletter_SelectedIndexChanged" 
                onsorting="gdletter_Sorting" PageSize="5" Width="840px">
                <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Room No" HeaderText="Room No" />
                    <asp:BoundField DataField="Inmates" HeaderText="Inmates" />
                    <asp:BoundField DataField="Reserved Date" HeaderText="Reserved Date" />
                    <asp:BoundField DataField="Rent" HeaderText="Rent" />
                </Columns>
            ...
            <asp:GridView ID="gdalloc" runat="server" AllowPaging="True" 
                ...
                OnSelectedIndexChanged="gdalloc_SelectedIndexChanged" Width="100%">
                <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                <Columns>
                    <asp:CommandField SelectText="" ShowSelectButton="True" />
                    <asp:BoundField DataField="id" HeaderText="id" Visible="False" />
                    <asp:BoundField DataField="No" HeaderText="No" />
                    <asp:BoundField DataField="Reciept" HeaderText="Reciept" />
                    <asp:BoundField DataField="Swami Name" HeaderText="Swami Name" />
                    <asp:BoundField DataField="Building" HeaderText="Building" />
                    <asp:BoundField DataField="Room" HeaderText="Room" />
                    <asp:BoundField DataField="Inmates" HeaderText="Inmates" />
                    <asp:BoundField DataField="Alloc Date" HeaderText="Alloc Date" />
                    <asp:BoundField DataField="Vecate Date" HeaderText="Vecate Date" />
                    <asp:BoundField DataField="Rent" HeaderText="Rent" />
                    <asp:BoundField DataField="Inmate charge" HeaderText="Inmate charge" />
...
&nbsp;</td>
        <td align="center" style="HEIGHT: 744px" valign="top">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Panel ID="Panel1" runat="server" Height="50px" Width="100%">
                <table width="100%">
                    <tbody>
                        ...
                        <tr>
                            <td style="WIDTH: 111px; HEIGHT: 17px">
                                &nbsp;<asp:Panel ID="Panel6" runat="server" BackColor="#9DCCF6" class="PopUpPanel" 
                                    DefaultButton="btnlogin" Visible="False">
                                    <table class="style4">
                                        <tr>
                                            <td width="50%">
                                                &nbsp;</td>
                                        ...
                                        <tr>
                                            <td width="50%">
                                                <asp:Button ID="btncancellpopup" runat="server" CausesValidation="False" 
                                                    onclick="btncancellpopup_Click" Text="Cancel" />
                                            </td>
                                            <td width="50%">
                                                <asp:Button ID="btnlogin" runat="server" CausesValidation="False" 
                        ...
                        <tr>
                            <td style="WIDTH: 111px; HEIGHT: 17px">
                                &nbsp;<asp:Panel ID="Panel7" runat="server" BackColor="#9DCCF6" class="PopUpPanel" 
                                    DefaultButton="btnset" Visible="False">
                                    <table class="style4">
                                        <tr>
                                            <td colspan="2">
                                                Set receipt No.</td>
                                        ...
                                        <tr>
                                            <td width="50%">
                                                Starting receipt No.</td>
                                            <td width="50%">
                                                <asp:TextBox ID="txtrecstart" runat="server" Width="160px"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="50%">
                                                Ending receipt No.</td>
                                            <td width="50%">
                                                <asp:TextBox ID="txtrecend" runat="server" Width="160px"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="50%">
                                            ...
                                            <td width="50%">
                                                <asp:Button ID="btnset" runat="server" CausesValidation="False" 
                                                    onclick="btnset_Click" Text="Set" />
                                            </td>
                                        </tr>
                                    </table>
                                </asp:Panel>
                        ...
                        <tr>
                            <td style="WIDTH: 111px; HEIGHT: 17px">
                                ...
                                <asp:Button ID="btnviewallocation" runat="server" CausesValidation="False" 
                                    CssClass="btnStyle_medium" Font-Bold="True" onclick="btncancel_Click" 
                                    tabIndex="23" Text="View Allocation" Visible="False" />
                            </td>
                            <td style="WIDTH: 111px; HEIGHT: 17px">
                                &nbsp;</td>
                        </tr>
    ...
    <tr>
        <td colspan="5">
            <asp:Panel ID="pnlcard1" runat="server" BackColor="skyblue">
                             <table class="style4" style="text-align: left">
                                 <tr>
                                     <td colspan="4" style="text-align: center">
                                         <asp:Label ID="lblCardHead" runat="server" Text="Card Payment"></asp:Label>
                                     </td>
                                 </tr>
                                 <tr>
                                     <td width="20%" >
                                         <asp:CheckBox ID="chkSameSwami1" runat="server" AutoPostBack="True" 
                                             oncheckedchanged="chkSameSwami1_CheckedChanged" Text="Same Swami" />
                                     </td>
                                     <td width="30%" >&nbsp;</td>
                                     <td width="20%" >&nbsp;</td>
                                     <td width="30%" class="style5" >
                                         <asp:ImageButton ID="imgCloseCard1" runat="server" 
                                             ImageUrl="~/Images/close.gif" />
                                     </td>
                                 </tr>
                                 <tr>
                                     <td width="20%">
                                         <asp:Label ID="lblSwaminame1" runat="server" Text="Swami name"></asp:Label>
                                     </td>
                                     <td width="30%">
                                         <asp:TextBox ID="txtSwaminame1" runat="server"></asp:TextBox>
                                     </td>
                                     <td width="20%">
                                         <asp:Label ID="lblBank1" runat="server" Text="Bank"></asp:Label>
                                     </td>
                                     <td width="30%">
                                         <asp:TextBox ID="txtBank1" runat="server"></asp:TextBox>
                                     </td>
                                 </tr>
                                 <tr>
                                     <td>
                                         <asp:Label ID="lblEmailid1" runat="server" Text="Email id"></asp:Label>
                                     </td>
                                     <td>
                                     ...
                                     <td>
                                         <asp:TextBox ID="txtBranch1" runat="server"></asp:TextBox>
                                     </td>
                                 </tr>
                                 <tr>
                                     <td>
                                         <asp:Label ID="lblPhoneno1" runat="server" Text="Phone no"></asp:Label>
                                     </td>
                                     <td>
                                         <asp:TextBox ID="txtPhoneno1" runat="server"></asp:TextBox>
                                     </td>
                                     <td>
                                         <asp:Label ID="lblAccountno1" runat="server" Text="Account no"></asp:Label>
                                     </td>
                                     <td>
                                 ...
                                 <tr>
                                     <td>
                                         <asp:Label ID="lblReceiptno1" runat="server" Text="Receipt no"></asp:Label>
                                     </td>
                                     <td>
                                         <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
                                     </td>
                                     <td>
                                         <asp:Label ID="lblIFSCcode1" runat="server" Text="IFSC code"></asp:Label>
                                     </td>
                                     <td>
                                         <asp:TextBox ID="txtIFSCcode1" runat="server"></asp:TextBox>
                                     </td>
                                 </tr>
                                 <tr>
                                     <td>
                                         <asp:Label ID="lblTransactionno1" runat="server" Text="Transaction no"></asp:Label>
                                     </td>
                                     <td>
                                         <asp:TextBox ID="txtTransactionno1" runat="server"></asp:TextBox>
                                     </td>
                                     <td>
                                         &nbsp;</td>
                                     <td>
                                         <asp:Button ID="btnsubmitcard1" runat="server" CssClass="btnStyle_medium" 
                                             Text="Submit" onclick="btnsubmitcard1_Click" />
                                     </td>
                                 </tr>
                                 <tr>
                                     <td>
            ...
            <ajaxToolkit:ModalPopupExtender runat="server" ID="modelPopUpCard1" TargetControlID="btn1" PopupControlID="pnlcard1" BackgroundCssClass="modalBackground" OkControlID="btnsubmitcard1" CancelControlID="imgCloseCard1">
            </ajaxToolkit:ModalPopupExtender>
            <ajaxToolkit:ModalPopupExtender runat="server" ID="modelPopUpCard2" TargetControlID="btn2" PopupControlID="pnlCardCash1" BackgroundCssClass="modalBackground" OkControlID="btnsubmitcard2" CancelControlID="imgCloseCard2">
            </ajaxToolkit:ModalPopupExtender>
        </td>
    </tr>
    <tr>
        <td colspan="5">
              <asp:Panel ID="pnlCardCash1" runat="server" BackColor="SkyBlue">
                     <table class="style4">
                         <tr>
                             <td colspan="4">
                                 <asp:Label ID="lblCardandcashHead" runat="server" Text="Card and cash"></asp:Label>
                             </td>
                         </tr>
                         <tr>
                             <td width="20%">
                             ...
                             <td width="20%">
                                 &nbsp;</td>
                             <td width="30%" class="style5">
                                 <asp:ImageButton ID="imgCloseCard2" runat="server" 
                                     ImageUrl="~/Images/close.gif" />
                             </td>
                         </tr>
                         <tr>
                             <td width="20%">
                                 <asp:Label ID="lblReceiptno2" runat="server" Text="Receipt no"></asp:Label>
                             </td>
                             <td width="30%">
                                 <asp:TextBox ID="TextBox2" runat="server"></asp:TextBox>
                             </td>
                             <td width="20%">
                                 <asp:Label ID="lblTransactionno2" runat="server" Text="Transaction no"></asp:Label>
                             </td>
                             <td width="30%">
                                 <asp:TextBox ID="txtTransactionno2" runat="server"></asp:TextBox>
                             </td>
                         </tr>
                         <tr>
                             <td>
                             ...
                             <td>
                                 &nbsp;</td>
                             <td>
                                 <asp:Button ID="btnsubmitcard2" runat="server" CssClass="btnStyle_medium" 
                                     Text="Submit" />
                             </td>
                         </tr>
                         <tr>
    ...
    <tr class="stylepop">
        <td colspan="5">
            <asp:Button ID="btn1" runat="server" CssClass="stylepop" 
                CausesValidation="False" />
            <asp:Button ID="btn2" runat="server" CssClass="stylepop" 
                CausesValidation="False" />
            <asp:Button ID="btn3" runat="server" CssClass="stylepop" 
                CausesValidation="False" />
        </td>
    </tr>
    <tr>
        <td colspan="5">
            <asp:Panel ID="pnlDD1" runat="server" BackColor="SkyBlue">
                <table class="style4">
                    <tr>
                        <td colspan="4">
                            <asp:Label ID="lblDDHead" runat="server" Text="DD payment"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td width="20%">
                        ...
                        <td style="text-align: right" width="30%">
                            <asp:ImageButton ID="imgCloseDD3" runat="server" 
                                ImageUrl="~/Images/close.gif" />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td width="30%">
                            <asp:TextBox ID="txtDDDate3" runat="server"></asp:TextBox>
                            <cc1:CalendarExtender ID="txtDDDate3_CalendarExtender" runat="server" 
                                Enabled="True" Format="dd/MM/yyyy" TargetControlID="txtDDDate3">
                            </cc1:CalendarExtender>
                        </td>
                        <td width="20%">
                            <asp:Label ID="lblBank3" runat="server">Bank</asp:Label>
                        </td>
                        <td width="30%">
                            <asp:TextBox ID="txtBank3" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Label ID="lblDDno3" runat="server">DD No</asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtDDNo3" runat="server"></asp:TextBox>
                        </td>
                        <td>
                            <asp:Label ID="lblBranch3" runat="server">Branch</asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtBranch3" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            &nbsp;</td>
                        <td>
                            <asp:Button ID="btnsubmitDD3" runat="server" CssClass="btnStyle_medium" 
                                Text="Submit" onclick="btnsubmitDD3_Click" />
                        </td>
                    </tr>
                    <tr>
                        <td>
            ...
            <ajaxToolkit:ModalPopupExtender runat="server" ID="ModalPopupDD3" TargetControlID="btn3" PopupControlID="pnlDD1" BackgroundCssClass="modalBackground" OkControlID="btnsubmitDD3" CancelControlID="imgCloseDD3">
            </ajaxToolkit:ModalPopupExtender>
        </td>
    </tr>
    <tr>
 ...
 <Triggers>
  ...
  <%--<asp:PostBackTrigger ControlID="ddlpayment" />--%>
   </Triggers>
  </asp:UpdatePanel>    
    <br />
    <br />
