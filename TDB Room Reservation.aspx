<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="TDB Room Reservation.aspx.cs" Inherits="TDB_Room_Reservation" %>
                ...
                <tr>
                    <td align="center" colspan="3" style="height: 24px">
                        <asp:Label ID="lblheading" runat="server" 
                            __designer:wfdid="w8" CssClass="heading" Font-Bold="True" 
                            Font-Size="Medium" Text="TDB Reservation" Width="150px"></asp:Label>
                    </td>
                </tr>
                <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            <asp:DropDownList ID="cmbReason" runat="server" 
                                                ...
                                                Width="146px" Visible="False">
                                            </asp:DropDownList>
                                        </td>
                                        <td style="WIDTH: 23px">
                                            <asp:LinkButton ID="lnkReason" runat="server" 
                                                __designer:wfdid="w4" CausesValidation="False" 
                                                ForeColor="Blue" onclick="lnkReason_Click" 
                                                Visible="False">New</asp:LinkButton>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="WIDTH: 95px">
                                            <asp:Label ID="lblOfficerName" runat="server" 
                                                __designer:wfdid="w5" Text="Officer Name"></asp:Label>
                                            *</td>
                                        <td colspan="2">
                                            <asp:TextBox ID="txtOfficer" runat="server" 
                                                __designer:wfdid="w7" Width="141px"></asp:TextBox>
                                        </td>
                                        <td style="WIDTH: 23px">
                                            &nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td style="WIDTH: 95px">
                                            <asp:Label ID="lblswminame" runat="server" 
                                                __designer:wfdid="w232" Text="Swami name" Width="75px" 
                                                style="margin-right: 0px"></asp:Label>
                                            *</td>
                                        <td colspan="2">
                                            <asp:TextBox ID="txtSwaminame" runat="server" 
                                                __designer:wfdid="w233" AutoPostBack="True" 
                                                OnTextChanged="txtSwaminame_TextChanged" TabIndex="51" 
                                                Width="135px" style="height: 22px"></asp:TextBox>
                                        </td>
                                        <td style="WIDTH: 23px">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="WIDTH: 95px">
                                            <asp:Label ID="lblplce" runat="server" 
                                                __designer:wfdid="w234" Text="Place" Width="35px"></asp:Label>
                                            *</td>
                                        <td colspan="2">
                                    ...
                                    <tr>
                                        <td style="WIDTH: 95px">
                                            <asp:Label ID="lblstate" runat="server" 
                                                __designer:wfdid="w236" Text="State" Width="35px"></asp:Label>                                            
                                            *</td>
                                        <td colspan="2">
                                    ...
                                    <tr>
                                        <td style="WIDTH: 95px" valign="top">
                                            <asp:Label ID="lbldistrict" runat="server" 
                                                __designer:wfdid="w238" Text="District" Width="40px"></asp:Label>                                            
                                            *</td>
                                    ...
                                    <tr>
                                        <td style="WIDTH: 95px; HEIGHT: 26px">
                                            <asp:Label ID="lblphnno" runat="server" 
                                                __designer:wfdid="w241" Text="Phoneno" Width="50px"></asp:Label>
                                            </td>
                                        <td style="HEIGHT: 26px">
                                            <asp:TextBox ID="txtStd" runat="server" 
                                                __designer:wfdid="w242" MaxLength="5" 
                                                Width="42px" TabIndex="55"></asp:TextBox>
                                        </td>
                                        <td style="HEIGHT: 26px">
                                            <asp:TextBox ID="txtPhn" runat="server" 
                                                __designer:wfdid="w243" MaxLength="10" 
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2" style="HEIGHT: 26px">
                                            <asp:TextBox ID="txtEmail" runat="server" 
                                                ...
                                                Width="135px" TabIndex="58"></asp:TextBox>
                                        </td>
                                        <td rowspan="1" style="WIDTH: 23px; HEIGHT: 26px">
                                            &nbsp;</td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2" style="HEIGHT: 26px">
                                            <asp:TextBox ID="txtProofNo" runat="server" 
                                                ...
                                                ontextchanged="txtProofNo_TextChanged"></asp:TextBox>
                                        </td>
                                        <td rowspan="1" style="WIDTH: 23px; HEIGHT: 26px">
                                        </td>
                                    </tr>
                        ...
                        <asp:Panel ID="pnlreservtn" runat="server" 
                            ...
                            <table>
                                <tbody>
                                    ...
                                    <tr>
                                        <td style="WIDTH: 100px; HEIGHT: 26px">
                                            <asp:Label ID="lbltodate" runat="server" 
                                                __designer:wfdid="w111" Text="Check out date" 
                                        ...
                                        <td style="WIDTH: 115px">
                                            <asp:TextBox ID="txtTodate" runat="server" 
                                                ...
                                                ValidationGroup="Mtodate" Width="135px" TabIndex="64" style="height: 22px"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="WIDTH: 100px; HEIGHT: 12px">
                                            <asp:Label ID="lblchckout" runat="server" 
                                                ...
                                                Width="88px"></asp:Label>
                                            *</td>
                                        <td style="WIDTH: 115px; HEIGHT: 12px">
                                            <asp:TextBox ID="txtchkout" runat="server" 
                                                __designer:wfdid="w114" AutoPostBack="True" 
                                                OnTextChanged="txtchkout_TextChanged1" style="height: 22px" 
                                    ...
                                    <tr>
                                        ...
                                        <td style="WIDTH: 115px; HEIGHT: 25px">
                                            <asp:TextBox ID="txtnoofhours" runat="server" 
                                                ReadOnly="True" TabIndex="67" Width="135px" 
                                                ontextchanged="txtnoofhours_TextChanged"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="WIDTH: 100px; HEIGHT: 25px">
                                    ...
                                    <tr>
                                        <td style="WIDTH: 100px; HEIGHT: 25px">
                                            <asp:Label ID="lblbuildingname0" runat="server" Text="Building name" 
                ...
                <tr>
                    <td colspan="3">
                        <asp:RegularExpressionValidator ID="RegMobile" 
                            ...
                            ErrorMessage="Enter a valid Mobile No" Font-Size="Smaller" 
                            ForeColor="#EEEEEE" SetFocusOnError="True" 
                            ValidationExpression="^0{0,1}[1-9]{1}[0-9]{2}[\s]{0,1}[\-]{0,1}[\s]{0,1}[1-9]{1}[0-9]{6}$"></asp:RegularExpressionValidator>
